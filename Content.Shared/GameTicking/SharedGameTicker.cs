...
namespace Content.Shared.GameTicking
{
     ...
     * <param name="jobsAvailable">A dictionary of job prototypes and the number of job positions available for it.</param>
     * <param name="isLateJoinStation">Whether or not this station is a late join station (== not a player ship) this is
     * based on if it has the lobby information component value set to true or false.</param>
