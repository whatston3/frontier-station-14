...
frontier-lobby-station-subtext = Wake up from cryosleep to become a captain, head out on adventure, or work on-station as a janitor, mail carrier, or security staff.
...
frontier-lobby-exped-description =
   Base camp for mercenaries and adventurers. Here you can:
...
frontier-lobby-pirate-description =
   The ultimate hideout where scallywags and pirates gather. Here you can:
   ...
   Note: First Mate and Captain are whitelist-only roles. Make an application in the Discord to play.
